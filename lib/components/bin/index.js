...
const Bin = ({
  ...
  return (
    <Wrapper>
      { actionsPopup ? <Actions Titleform={Titleform} Noteform={Noteform} handleActionsPopup={handleActionsPopup} status={status} updateProcess={updateProcess} /> : ''}
      <BinContainer>
        <MainHeader>
          <BinHeader name={name} toggleActions={handleActionsPopup} actionsPopup={actionsPopup} />

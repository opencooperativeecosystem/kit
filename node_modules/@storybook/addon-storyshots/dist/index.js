...
exports.renderOnly = exports.shallowSnapshot = exports.snapshot = exports.snapshotWithOptions = undefined;
...
function testStorySnapshots() {
  ...
  // eslint-disable-next-line
  options.test = options.test || _testBodies.snapshot;
  ...
  var _loop = function _loop(group) {
    ...
    (0, _global.describe)(suite, function () {
      (0, _global.describe)(group.kind, function () {
        var _loop2 = function _loop2(story) {
          ...
          (0, _global.it)(story.name, function () {
            ...
            return options.test({ story: story, context: context });
          });
        };
